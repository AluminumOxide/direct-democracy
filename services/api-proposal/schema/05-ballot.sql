...
ALTER TABLE ballot ADD COLUMN membership_id UUID;
ALTER TABLE ballot ADD COLUMN is_approved BOOLEAN;
ALTER TABLE ballot ADD COLUMN is_verified BOOLEAN;
ALTER TABLE ballot ADD COLUMN comments VARCHAR;
ALTER TABLE ballot ADD COLUMN modifiable BOOLEAN DEFAULT TRUE;
