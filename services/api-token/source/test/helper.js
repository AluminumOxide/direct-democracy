...
// unit tests
const fill_buckets_unit = async(request, reply, db, log) => {
	return await require('../handlers/bucket/fill')(request, reply, db, log)
}

const step_one_unit = async(request, reply, db, log) => {
	return await require('../handlers/step/one')(request, reply, db, log)
}

const step_two_unit = async(request, reply, db, log) => {
	return await require('../handlers/step/two')(request, reply, db, log)
}

const step_three_unit = async(request, reply, db, log) => {
	return await require('../handlers/step/three')(request, reply, db, log)
}
